...
public class BigIntCalcParser extends Parser {
	...
	public static final int
		...
		T__9=10, VAR=11, NUM=12, WS=13, COMMENT=14;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_showStmt = 2, RULE_assignStmt = 3, 
		RULE_expr = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "showStmt", "assignStmt", "expr"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6356L) != 0)) {
				{
				{
				setState(10);
				statement();
	...
	public static class AssignStmtContext extends ParserRuleContext {
		...
		public TerminalNode VAR() { return getToken(BigIntCalcParser.VAR, 0); }
